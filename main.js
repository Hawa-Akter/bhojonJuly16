...
ipcMain.on("editOrderItem", (e, editOrderId) => {
  ...
  mainWin.webContents.on("did-finish-load", () => {
    ...
    console.log("orderDetailList", orderDetailList.length);

    console.log("--------------");
  });
});
console.log("prity", orderDetailList);

ipcMain.on("updateOrder", (e, updaeOrderItems) => {
  updaeOrderItems.map((item) => {
    console.log(" edit order item", item);
